...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_ENABLE_NEW_GEN_SPLIT = "enable-gen-split";
    public static final String GENERAL_CONFIGURATION_ENABLE_NEW_GEN_SPLIT_RADIUS = "enable-gen-split";
